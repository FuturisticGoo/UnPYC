...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radio_pyc = QtWidgets.QRadioButton(self.centralwidget)
        self.radio_pyc.setChecked(True)
        self.radio_pyc.setObjectName("radio_pyc")
        self.horizontalLayout_8.addWidget(self.radio_pyc)
        self.radio_pyinstaller = QtWidgets.QRadioButton(self.centralwidget)
        self.radio_pyinstaller.setObjectName("radio_pyinstaller")
        self.horizontalLayout_8.addWidget(self.radio_pyinstaller)
        ...
        self.python_source.addItem("")
        self.python_source.addItem("")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.python_source)
        ...
        self.wpsw_check = QtWidgets.QCheckBox(self.centralwidget)
        self.wpsw_check.setObjectName("wpsw_check")
        self.verticalLayout.addWidget(self.wpsw_check)
        self.verticalLayout_3.addLayout(self.verticalLayout)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.custom_source_loc = QtWidgets.QLineEdit(self.centralwidget)
        self.custom_source_loc.setReadOnly(True)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.step_3)
        ...
        self.destination_loc.setReadOnly(True)
        ...
        self.horizontalLayout_11.addWidget(self.console_output)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio_pyc.setText(_translate("MainWindow", ".pyc / .pyo file"))
        self.radio_pyinstaller.setText(_translate("MainWindow", "Pyinstaller file"))
        self.step_1.setText(_translate("MainWindow", "Step 1"))
        self.pyc_loc.setText(_translate("MainWindow", "Source File"))
        self.open_pyc_file.setText(_translate("MainWindow", "Open pyc/pyo file"))
        ...
        self.wpsw_check.setText(_translate("MainWindow", "Download the wpsw wu6 version"))
